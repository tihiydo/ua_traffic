...
type NavLink =
    {
        title: string;
        path: `/admin/moderation${string}`;
    };

const advertiserNavLinks: Array<NavLink> =
    [
        { path: "/admin/moderation/bloggers", title: "Блогери" },
        { path: "/admin/moderation/advertisments", title: "Рекламні пости" },
        { path: "/admin/moderation/adv-requests", title: "Рекламні заявки" },
        {path: "/admin/moderation/reviews", title: "Відгуки"},
    ];
