...
const AdminModerationAdReqPage = async ({ params }: Props) => {
    const advertismentReqest = await api.admin.advertisment.getAdvRequest.query({ requestId: params.requestId }) as AdRequestType
...
export default AdminModerationAdReqPage