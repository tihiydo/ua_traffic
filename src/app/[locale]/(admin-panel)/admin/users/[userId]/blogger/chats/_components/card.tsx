        ...
        <>
            {
                ...
                props.conservations.map(( value, key ) =>
                    <div key={value.id} className="w-full border-gray-secondary border h-[8rem] rounded-md p-4 mb-2 cursor-pointer" onClick={() => props.onSelected(value.id)}>
                        <h3 className="font-bold">Заявка №{key + 1}</h3>
                        <p>{value.with}</p>
