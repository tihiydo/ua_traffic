...
import RatingBloggersList from './rating-bloggers-list'
...
const RatingBloggerSection = () => {
    return (
        <div className="mb-32">
            <div className='flex flex-col gap-3 justify-start sm:flex-row sm:items-center sm:gap-10 mb-6'>
                <h2 className="uppercase text-2xl font-title first-letter:bg-yellow">
                    <Translate namespace="Landing" itemKey="topchannels" />
                </h2>
                <Link href={'/catalog?sortOrder=desc&sortBy=rating'} className='group font-medium flex items-center transition-colors text-main/80 hover:text-main hover:underline'>
                ...
                <div className="mt-8">
                    <CustomTabs defaultValue="instagram">
                        ...
                        <CustomTabsContent value={"instagram"}>
                            <RatingBloggersList tab="Instagram" />
                        </CustomTabsContent>

                        <CustomTabsContent value={"telegram"}>
                            <RatingBloggersList tab="Telegram" />
                        </CustomTabsContent>
                    </CustomTabs>
                </div>
            </div>
...
export default RatingBloggerSection