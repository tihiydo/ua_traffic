...
import {  TimerIcon, WalletIcon } from 'lucide-react';
...
const BillingsTab = ({ user, isLoading }: Props) => {
    return (
        <div className="max-w-[60rem] w-full border-gray border border-1 shadow-md rounded-md">
            <SpaceAlert
                icon={<WalletIcon size={30} strokeWidth={1.5} className='sm:block hidden'/>}
            ...
            <SpaceAlert
                icon={<TimerIcon size={30} strokeWidth={1.5} className='sm:block hidden'/>}
