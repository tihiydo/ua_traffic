...
export function DataTable<TData, TValue>({
    ...
    return (
        <div>
            <div className="flex flex-col sm:flex-row items-start justify-between gap-4 sm:gap-7">
                ...
                <div className="flex items-center">
                    <Button className="mt-0 mb-3 sm:mt-9">
                        <Link href={`/${locale}/advertiser/new-post`}>
