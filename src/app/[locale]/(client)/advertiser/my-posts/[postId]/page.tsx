...
const AdvertismentPostPage = async ({ params }: Props) => {
    const advertismentPost = await api.advertisment.posts.getPost.query({ id: params.postId })
    return (
        <div>
...
export default AdvertismentPostPage