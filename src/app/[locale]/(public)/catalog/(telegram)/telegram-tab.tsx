...
import TelegramFilters from './telegram-filter'
...
const TelegramTab = ({ filterSettings, pageBloggers, totalBloggersCount }: Props) => {
    return (
        <div className="@container/catalog-tab">
            <div className='grid grid-cols-2 @5xl/catalog-tab:grid-cols-3 @[72rem]/catalog-tab:grid-cols-4 gap-x-5 '>
                <div className='col-span-2 @[72rem]/catalog-tab:col-span-3'>
                    <div className='flex w-full justify-between gap-5 mb-5'>
                        ...
                        <FiltersSheet>
                            <div className='mt-8'>
                                <TelegramFilters settings={filterSettings} />
                            </div>
                        </FiltersSheet>
                    </div>
