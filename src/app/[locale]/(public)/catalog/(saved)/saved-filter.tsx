...
const SavedFilters = ({ settings }: Props) => {
    const {
        update,
        merge,
        schemaParams,
        include
    } = useCatalogParams(settings);
    ...
    }, [settings.minSubs, settings.maxSubs])
    ...
    return (
        <div>
            ...
            <div className='mt-5'>
                ...
                <PostTypesSelect
                    postTypes={Object.values(AdPostType)}
                    value={Object.values(AdPostType).includes(filters.postType! as AdPostType) ? filters.postType! as AdPostType : undefined}
                    onChange={(value) => {
                        merge({
                            postType: value,
                            minPrice: undefined,
