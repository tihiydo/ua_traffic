        ...
        <DayPicker
            ...
            classNames={{
                ...
                day: cn(
                    ...
                    "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:!bg-yellow/40"
                ),
                day_selected: "bg-yellow/80 hover:bg-yellow/80 focus:bg-yellow/80 rounded-md",
                day_today: "bg-yellow/20 text-main",
                ...
                day_range_middle:"day-range-middle  aria-selected:bg-gray !rounded-none",
