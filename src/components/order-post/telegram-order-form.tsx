...
const TelegramOrderPostForm = ({ blogger, onSubmit, isLoading, schema, initialPostType }: Props) => {
        ...
        <Form {...form}>
            ...
            >
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem className='w-full'>
                                <div>
                                    <FormLabel className='font-bold'><Translate namespace='Catalogue' itemKey='arrangement-type' /></FormLabel>
                                </div>

                                <FormControl>
                                    <Select
                                        value={field.value}
                                        placeholder={t('Catalogue.select-arrangement-type')}
                ...
                <div className='w-full mt-4'>
                    ...
                    <div className='font-bold flex items-center justify-between w-full text-xs mt-1 md:text-sm'>
                        <h6>
...
export default TelegramOrderPostForm