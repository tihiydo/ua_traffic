                  ...
                  <tr>
                    <td>
                      <div class="chiuaua" style="color: #000000; text-align: left; padding: 0 4em;">
                        <h2 style="font-weight: 400; color: #000000; font-size: 22px; margin-bottom: 8px;">Для зміни пошти перейдіть за посиланням</h2>
                          <div class="btnflex" style="margin: 2rem 0; width: fit-content;"><a href='${env.NEXT_PUBLIC_SITE_URL}/profile/settings?v-email=${verificationToken}' class="btn btn-primary" style="text-transform: uppercase;">Перейти</a></div>
                        </p>
                      </div>
                    </td>
                  </tr>
